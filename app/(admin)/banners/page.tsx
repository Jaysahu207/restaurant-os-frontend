...
import { updateBanner, getRestaurantBanners, deleteBanner, createBanner, toggleBannerStatus, } from "@/services/bannerService";
                            ...
                            {loading ? (
                                ...
                                banners.map((banner) => (
                                    <tr key={banner._id} className="hover:bg-gray-50 transition">
                                        ...
                                        <td className="px-5 py-4">
                                            <span
                                                className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${banner.isActive
